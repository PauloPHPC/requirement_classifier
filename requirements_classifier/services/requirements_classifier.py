...
class RequirementsClassifier:
    ...
    def __init__(self, 
        ...
        self.user_prompt = """
        You are an expert in extracting USER requirements from texts. 
        The definition of USER is a person who benefits from the system being developed. 
        Your task is to extract information and rewrite from the text the software requirements that represents a functionality that the system will give to the user. 
        All the requirements generated by you have to be in the format: “As a <user type>, I want to <objective> for <reason>”. 
        Always ignore numbers. 
        Always make each requirement less than two sentences. 
        Always Ignore anything related to technical aspects of the system.
        Only use the dot to end the requirement, never before ending. 
        """

        self.system_prompt = """
        You are an expert in extracting SYSTEM requirements from texts. 
        The definition of a SYSTEM A set of interacting components that work together to achieve a specific goal or fulfill a defined purpose. 
        All the requirements generated by you have to be in the format: “The <system/entity> shall/must <functionality> <description>. 
        Always ignore numbers. 
        Always make each requirement less than two sentences. 
        All the requirements have technical aspects of the system.
        Only use the dot to end the requirement, never before ending.
        """
