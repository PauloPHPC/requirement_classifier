...
class RequirementsClassifier:
    ...
    def process_page(self, page_content, page_number):
        ...
        user_req_text = generate_requirements(self.phi4_pipeline, page_content, user_prompt_context)
        system_req_text = generate_requirements(self.phi4_pipeline, page_content, system_prompt_context)
